package programation.practice01;
...
public class Estructure {
    ...
    public String options[] = {"Fill bottle of water", "Throw content of bottle", ""
        + "Pour bottle 1 in bottle 2", "Pour bottle 2 in bottle 1", "Exit the problem"};
    ...
    public void insertBottle1InTheBottle2() {
        if (capacityBottle1 == 0 || capacityBottle2 == 3) {
            System.out.println("-------------------------------------");
            System.out.println("Empty bottle or full for the transfer");
            System.out.println("-------------------------------------");
        } else {
            for (int i = 0; i < 3; i++) {
                capacityBottle2++;
